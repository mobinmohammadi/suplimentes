...
import TopbarSlider from "./TopbarSlider/TopbarSlider.jsx";
...
export default function OnsPageSliderProduct({
  ...
  return (
    <div className="relative h-full">
      ...
      {isZoomed ? (
        <>
          <div className=" relative flex flex-col backdrop-blur-md h-full w-full items-center justify-center  text-white">
            <div className="absolute top-8 right-3 cursor-pointer ">
              <div onClick={() => {setIsZoomed(false)}} className="bg-red-400 p-2 rounded-md text-xs items-center flex gap-1 font-morabba absolute right-2 top-10">
                <span>بستن</span>
